...
class JobtitleController extends Controller
{
    ...
    {
        return view('backend.setup.job.create');
    }
	...
	return view('backend.setup.job.edit', compact('title'));
    }
	...
	return Redirect::route('admin.setup.job.titles.index')->withFlashSuccess('Job titles data was successfully edited.');
    }

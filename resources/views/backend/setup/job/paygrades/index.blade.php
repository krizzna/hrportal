...
@section('content')
	...
	<ul class="nav nav-tabs">
	    ...
	    <li class="active"><a href="{{route('admin.setup.job.paygrades.index')}}">Pay Grades</a></li>
	...
	<div class="tab-content">
		...
		<div class="pull-right" style="margin-bottom:10px">
		    <a href="{{route('admin.setup.job.paygrades.create')}}" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> Add New</a>
		</div>
		...
		<table id="paygrades" class="table table-bordered table-striped">
			...
			<tr>
			    ...
			    <td>
				<a href="{{route('admin.setup.job.paygrades.edit', $u->id)}}" class="btn btn-xs btn-info" data-toggle="tooltip" data-placement="left" title="Edit"><i class="fa fa-pencil"></i></a>
				<a href="{{route('admin.setup.job.paygrades.delete', $u->id)}}" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="right" title="Delete"><i class="fa fa-trash"></i></a>
			    </td>
			</tr>
			@endforeach
		    </tbody>

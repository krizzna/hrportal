...
@section ('breadcrumbs')
    ...
    <li class="active">{!! link_to_route('admin.setup.company.structures.index', 'Company Structure') !!}</li>
@stop
...
@section('content')
	...
	<div class="box-body">
		...
		<tbody>
			...
			<td>{!! $v -> parent !!}</td>
			<td>
			    <a href="{{route('admin.setup.company.structures.edit', $v->id)}}" class="btn btn-xs btn-info" data-toggle="tooltip" data-placement="left" title="Edit"><i class="fa fa-pencil"></i></a>
			    <a href="{{route('admin.setup.company.structures.delete', $v->id)}}" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="right" title="Delete"><i class="fa fa-trash"></i></a>
			</td>
		    </tr>
		    @endforeach
		</tbody>

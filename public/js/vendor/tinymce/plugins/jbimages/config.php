...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/img/post'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . '/public' . $config['img_path']; // Physical path. [Usually works fine like this]
